...
public class BinaryOperatorExpression extends Expression {
    ...
    public final static TokenRole LOGICAL_AND_ROLE = new TokenRole("&&");
    public final static TokenRole LOGICAL_OR_ROLE = new TokenRole("||");
    public final static TokenRole EXCLUSIVE_OR_ROLE = new TokenRole("^");
    public final static TokenRole GREATER_THAN_ROLE = new TokenRole(">");
    public final static TokenRole GREATER_THAN_OR_EQUAL_ROLE = new TokenRole(">=");
    public final static TokenRole EQUALITY_ROLE = new TokenRole("==");
    public final static TokenRole IN_EQUALITY_ROLE = new TokenRole("!=");
    public final static TokenRole LESS_THAN_ROLE = new TokenRole("<");
    public final static TokenRole LESS_THAN_OR_EQUAL_ROLE = new TokenRole("<=");
