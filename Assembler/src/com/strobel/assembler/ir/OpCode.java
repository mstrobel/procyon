...
public enum OpCode {
    ...
    LDC(0x12, FlowControl.Next, OpCodeType.Primitive, OperandType.U1, StackBehavior.Pop0, StackBehavior.Push1),
    LDC_W(0x13, FlowControl.Next, OpCodeType.Primitive, OperandType.U2, StackBehavior.Pop0, StackBehavior.Push1),
    LDC2_W(0x14, FlowControl.Next, OpCodeType.Primitive, OperandType.U2, StackBehavior.Pop0, StackBehavior.Push2),
    ...
    ATHROW(0xBF, FlowControl.Throw, OpCodeType.ObjectModel, OperandType.None, StackBehavior.PopA, StackBehavior.Push0),
    CHECKCAST(0xC0, FlowControl.Next, OpCodeType.ObjectModel, OperandType.TypeReference, StackBehavior.PopA, StackBehavior.Push0),
