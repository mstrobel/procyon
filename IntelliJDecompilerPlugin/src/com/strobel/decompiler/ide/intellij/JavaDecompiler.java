...
public class JavaDecompiler {
    ...
    public String decompile(final String originalPath, final String basePath, final String internalName) {
        ...
        settings.setOutputFileHeaderText(
            ...
            "Class File: " + originalPath + "\n" +
            "Compiler Target: " + resolvedType.getCompilerMajorVersion() + "\n"
        );
