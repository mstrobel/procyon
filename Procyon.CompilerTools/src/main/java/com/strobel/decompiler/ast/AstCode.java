...
public enum AstCode {
    ...
    public static boolean expandMacro(final StrongBox<AstCode> code, final StrongBox<Object> operand, final MethodBody body, final int offset) {
        ...
        switch (op) {
            ...
            case __ILoad0:
                code.set(Load);
                operand.set(body.getVariables().find(0, offset));
                return true;
            case __ILoad1:
                code.set(Load);
                operand.set(body.getVariables().find(1, offset));
                return true;
            case __ILoad2:
                code.set(Load);
                operand.set(body.getVariables().find(2, offset));
                return true;
            case __ILoad3:
                code.set(Load);
                operand.set(body.getVariables().find(3, offset));
                return true;
            case __LLoad0:
                code.set(Load);
                operand.set(body.getVariables().find(0, offset));
            ...
            case __IStore0:
                code.set(Store);
                operand.set(body.getVariables().find(0, offset + 1));
                return true;
            case __IStore1:
                code.set(Store);
                operand.set(body.getVariables().find(1, offset + 1));
                return true;
            case __IStore2:
                code.set(Store);
                operand.set(body.getVariables().find(2, offset + 1));
                return true;
            case __IStore3:
                code.set(Store);
                operand.set(body.getVariables().find(3, offset + 1));
                return true;
            case __LStore0:
                code.set(Store);
                operand.set(body.getVariables().find(0, offset + 1));
